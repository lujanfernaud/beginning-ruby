...
class TestWordPlay < Test::Unit::TestCase
	...
	# Test that multiple sentence blocks are split up into individual sentences correctly
	def test_sentences
	...
	# Test that basic pronouns are switched
	...
	# Test more complex sentence switches
